...
# Intruduction 
This library supports the parsing and editing of netlist files produced by EDA tools like Vivado. It was originally designed for parsing the **post-synthesis** netlist produced by Xilinx Vivado, but it can be used to modify any EDIF-formatted file. This EDIF parser supports any EDIF version, as the parsing logic is highly generic.
